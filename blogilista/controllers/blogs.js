  ...
  try {
    ...
    if (blog.user !== undefined) {
      if (decodedToken.id === blog.user.toString()) {
        ...
        console.log('the blog was not added by this user and thus cannot be removed by him')
        return response.status(401).json({ error: 'the blog was not added by this user and thus cannot be removed by him' })
      }
    } else {
      console.log('the blog was not added by this user and thus cannot be removed by him')
      return response.status(401).json({ error: 'the blog was not added by this user and thus cannot be removed by him' })
